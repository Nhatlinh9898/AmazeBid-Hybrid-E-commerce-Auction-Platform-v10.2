...
import { Product, ItemType, OrderStatus, LiveStream, User, Transaction, AvatarConfig, AvatarOutfit, AvatarEnvironment, FeedPost, Review, DiscountCode, ShippingOption, UserTier, Task, Voucher } from './types';
...
/** Catalog nhiệm vụ loyalty (lưu db `tasks`, isCompleted được merge theo user) */
export const DEFAULT_LOYALTY_TASKS: Task[] = [
  { id: 'loy_task_login', title: 'Đăng nhập mỗi ngày', points: 10, type: 'WATCH_STREAM', isCompleted: false },
  { id: 'loy_task_stream', title: 'Xem livestream ít nhất 5 phút', points: 20, type: 'WATCH_STREAM', isCompleted: false },
  { id: 'loy_task_bid', title: 'Đặt giá tại một phiên đấu', points: 15, type: 'AUCTION_BID', isCompleted: false }
];

/** Catalog voucher đổi điểm (lưu db `vouchers`) */
export const DEFAULT_LOYALTY_VOUCHERS: Voucher[] = [
  {
    id: 'loy_v_5p',
    code: 'AMAZE5',
    discount: 5,
