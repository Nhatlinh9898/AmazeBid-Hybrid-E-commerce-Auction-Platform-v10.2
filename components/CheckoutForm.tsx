...
export default function CheckoutForm({ onSuccess = () => {}, onCancel, amount, orderId, userId }: CheckoutFormProps) {
    ...
    stripe.retrievePaymentIntent(clientSecret).then(({ paymentIntent }) => {
      switch (paymentIntent?.status) {
        case "succeeded":
          ...
          // Auto-trigger success callback after a short delay
        ...
        case "requires_payment_method":
          setMessage("Thanh toán không thành công. Vui lòng thử phương thức thanh toán khác.");
          break;
        default:
