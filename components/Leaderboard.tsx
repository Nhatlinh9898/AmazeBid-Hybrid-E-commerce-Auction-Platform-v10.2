    ...
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div className="flex items-end justify-center gap-4 mt-8 mb-2">
          ...
          {safeLeaderboard[1] && (
            <div className="flex flex-col items-center group">
              <div className="relative mb-2">
                <img 
                   src={safeLeaderboard[1].avatar} 
                   alt={safeLeaderboard[1].fullName} 
              ...
              <p className="text-xs font-bold truncate w-20 text-center">{safeLeaderboard[1].fullName}</p>
              <p className="text-[10px] text-blue-200">{(safeLeaderboard[1].points || 0).toLocaleString()} pts</p>
            </div>
          )}
          ...
          {safeLeaderboard[0] && (
            <div className="flex flex-col items-center group -translate-y-4">
              <div className="relative mb-2">
                ...
                <img 
                   src={safeLeaderboard[0].avatar} 
                   alt={safeLeaderboard[0].fullName} 
              ...
              <p className="text-sm font-black truncate w-24 text-center">{safeLeaderboard[0].fullName}</p>
              <p className="text-xs text-yellow-200 font-bold">{(safeLeaderboard[0].points || 0).toLocaleString()} pts</p>
            </div>
          )}
          ...
          {safeLeaderboard[2] && (
            <div className="flex flex-col items-center group">
              <div className="relative mb-2">
                <img 
                   src={safeLeaderboard[2].avatar} 
                   alt={safeLeaderboard[2].fullName} 
              ...
              <p className="text-xs font-bold truncate w-20 text-center">{safeLeaderboard[2].fullName}</p>
              <p className="text-[10px] text-blue-200">{(safeLeaderboard[2].points || 0).toLocaleString()} pts</p>
            </div>
          )}
        </div>
      </div>
      ...
      <div className="p-2">
        <div className="space-y-1">
          {safeLeaderboard.slice(3).map((user, index) => (
            <div 
              key={user.id} 
